INSERT ALL
  INTO TS_ADAM.TS_SETUBI_NEEDS_SUM2 (JUSHOCD1, TATEMONO_SYUBETU, SINGLE_FAMILY_FLG,SETUBI,RATE,PRIORITY,NEEDS)
...
FROM (
  ...
  FROM TS_ADAM.TS_SETUBI_NEEDS_SUM
